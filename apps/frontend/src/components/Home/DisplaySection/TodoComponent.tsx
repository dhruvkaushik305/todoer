...
const TodoComponent: React.FC<{ todo: TodoType }> = (props) => {
    ...
    return <div key={todo.id} className='flex items-center gap-3 bg-gray-800 rounded-lg p-2  border border-gray-800 hover:border-2 hover:border-gray-400 touch-none'  {...attributes} ref={setNodeRef} style={style}>
